...
import (
	...
	"github.com/openyurtio/yurt-app-manager/pkg/yurtappmanager/controller/nodepoolingress"
...
func init() {
	controllerAddFuncs = append(controllerAddFuncs, uniteddeployment.Add, nodepool.Add, nodepoolingress.Add)
}
