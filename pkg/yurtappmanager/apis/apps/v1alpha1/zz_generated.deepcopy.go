...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodePoolIngressCondition) DeepCopyInto(out *NodePoolIngressCondition) {
	*out = *in
	if in.Pools != nil {
		in, out := &in.Pools, &out.Pools
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodePoolIngressCondition.
func (in *NodePoolIngressCondition) DeepCopy() *NodePoolIngressCondition {
	if in == nil {
		return nil
	}
	out := new(NodePoolIngressCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NodePoolIngressStatus) DeepCopyInto(out *NodePoolIngressStatus) {
	*out = *in
	...
	if in.Status != nil {
		...
		*out = make([]NodePoolIngressCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
