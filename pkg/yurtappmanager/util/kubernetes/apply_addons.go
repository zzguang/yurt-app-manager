...
func CreateNginxIngressSpecificResource(client client.Client, poolname string, replicas int32) error {
	// 1. Create Deployment
...
func DeleteNginxIngressSpecificResource(client client.Client, poolname string) error {
	// 1. Delete Deployment
